...
contract DutchAuctionLaunchPad is BaseHook {
        ...
        returns (bytes4)
    {
        ...
        address _paymentToken;
        {
            ...
            if (
                _salePeriod < 0 || _initialTokenSupply < 0 || _initialPrice < 0 || _decayConstant < 0
                    || _emissionRate < 0
        ...
        returns (bytes4, BeforeSwapDelta, uint24)
    {
        ...
        if (auctionOver[poolId]) {
            ...
            SD59x18 secondsOfEmissionsAvailable =
                sd(int256(block.timestamp) * 1e18) - lastAvailableAuctionStartTime[poolId];
            ...
            }
            {
                ...
                SD59x18 timeSinceLastAuctionStart =
                    sd(int256(block.timestamp) * 1e18) - lastAvailableAuctionStartTime[copyPoolId];
